...
public class MyDemoLoggingAspect {
	...
	//logger para que la salida por consola se organice y se sincronicen las 
	//salidas de spring y de la app
	private Logger myLogger = 
			Logger.getLogger(getClass().getName());
	
	
	/*
	 * Around para que se pueden manejar AOPs antes y despues de ejecutar un 
	 * metodo y ademas se puedan manejar excepciones
	 */
	...
	public Object aroundGetFortune(
		...
		try {
			...
			throw e;
			/*
			 * la idea de rethrown, es informar que hubo un error y no simplemente
			 * obviarlo con algun mensaje. si no reenviarlo a la APP
			 */
		}
